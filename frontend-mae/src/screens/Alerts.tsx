...
export function ScreenAlerts({ go }: { go: Go }) {
...
function AlertCard({ kind, unread, title, body, time }: AlertItem) {
  const icons: Record<AlertKind, { bg: string; fg: string; svg: React.ReactNode }> = {
