...
export interface SetTweakFn<T extends object> {
...
export type RadioOption<V extends string = string> = V | { value: V; label: React.ReactNode };

export function TweakRadio<V extends string = string>({
  ...
  const opts = options.map((o) =>
    typeof o === 'object' ? o : ({ value: o, label: o } as { value: V; label: React.ReactNode }),
  );
...
export type SelectOption<V extends string = string> = V | { value: V; label: React.ReactNode };

export function TweakSelect<V extends string = string>({
  label, value, options, onChange,
}: {
  label?: React.ReactNode;
  value: V;
